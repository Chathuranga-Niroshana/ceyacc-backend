...
class Event(Base):
    ...
    media_url_one = Column(String(255), nullable=True)
    media_url_two = Column(String(255), nullable=True)
    media_url_three = Column(String(255), nullable=True)
    media_url_four = Column(String(255), nullable=True)
    media_url_five = Column(String(255), nullable=True)
